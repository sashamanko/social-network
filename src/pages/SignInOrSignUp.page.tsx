  ...
  return (
    <div style={{height: 'calc(100vh - 60px)'}} className='flex align-center justify-center'>
      <div style={{minWidth: '320px'}} className="item-block flex align-center flex-col">
        ...
        <Link to='/login' style={{ textAlign: 'center'}} className={btnClass + " w-100 mb-1"}>Login</Link>
        <Link to='/register' style={{ textAlign: 'center'}} className={btnClass + " w-100"}>Register</Link>
      </div>
    </div>
  );
};
